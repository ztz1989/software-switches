...
## p2p test
### Steps:
* Start BESS CLI: sudo ${BESS_DIR}/bessctl/bessctl 
* Designates the two ports with PCI address 0b:00.0 and 0b:00.1, modify it to your respective PCI addresses for reproduction.
    * run file p2p.bess
