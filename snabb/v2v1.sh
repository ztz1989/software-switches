...
cd path/to/qemu
sudo taskset -c 5-8 ./bin/x86_64-softmmu/qemu-system-x86_64 -name $VM_NAME2 -cpu host -enable-kvm \
  ...
  -chardev socket,id=char2,path=$VHOST_SOCK_DIR/vhost-user-2,server \
