...
function loopback_bi.new(conf)
   local o = {}
   return setmetatable(o, { __index = loopback_bi })
end

function loopback_bi:push()
...
local function show_usage(code)
   print(require("program.loopback-bi.README_inc"))
   main.exit(code)
end
