...
function run(args)
   ...
   config.app(c, "vi3", vhostuser.VhostUser, {socket_path="/tmp/snabb/vhost-user-3"})
   config.app(c, "vi4", vhostuser.VhostUser, {socket_path="/tmp/snabb/vhost-user-4"})

   config.link(c, "vi1.tx -> vi3.rx")
   config.link(c, "vi4.tx -> vi2.rx")
