...
if [[ "$#" -eq 0 ]]; then
    ...
    sudo $BINS/vppctl -s $PREFIX set int l2 xconnect $NAMELC0P1 $NAMELC0P7
    sudo $BINS/vppctl -s $PREFIX set int l2 xconnect $NAMELC0P7 $NAMELC0P1
else
    ...
    sudo $BINS/vppctl -s $PREFIX test l2patch rx $NAMELC0P1 tx $NAMELC0P7
    sudo $BINS/vppctl -s $PREFIX test l2patch rx $NAMELC0P7 tx $NAMELC0P1
fi
