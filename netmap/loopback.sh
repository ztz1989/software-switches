...
sudo vale-ctl -a vale0:enp11s0f1

echo 'Start Centos VM..'

sudo taskset -c 9-11 ./qemu/x86_64-softmmu/qemu-system-x86_64 CentOS-7-x86_64-Azure.qcow2 \
     --enable-kvm -smp 4 -m 2G -nographic -cpu host \
