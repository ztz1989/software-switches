...
sudo ovs-ofctl add-flow br-acl "in_port=3 actions=5"
sudo ovs-ofctl add-flow br-acl "in_port=4 actions=6"
sudo ovs-ofctl add-flow br-acl "in_port=5 actions=3"
sudo ovs-ofctl add-flow br-acl "in_port=6 actions=4"
